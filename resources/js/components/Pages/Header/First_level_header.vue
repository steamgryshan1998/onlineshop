<template>
    ...
    padding: 0px 13px; padding-bottom: 0px">
        ...
        <div class="row_1" >
            ...
            <div class="col-4" style="margin-top: 10px; padding-left: 63px; text-transform:uppercase; font-family: 'Poppins', sans-serif;    font-size: 90%;     letter-spacing: 0.062em;" >
                Days a week from 9:00 am to 7:00 pm
            </div>
            <div class="col-4">
            </div>

            <div class="col-1 " style="margin-left: 48px; margin-top: 8px" >
